							...
							<section class="panel">
								...
								<div class="panel-body">
									<div class="col-sm-6 col-xs-12">
										<form id="frm_nproducto" class="form-horizontal form-bordered" action="#">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="input-group">
														...
														<input type="text" name="valor" class="form-control" placeholder="Ej.: 780" required/>
													</div>
												</div>
												<div class="col-sm-9">
									...
									<div class="col-sm-6 col-xs-12">
										...
										<div class="frm_imgupl">
											...
											<div class="col-sm-12">
												<form action="upload/upload.php" class="dropzone dz-square" id="myAwesomeDropzone">
